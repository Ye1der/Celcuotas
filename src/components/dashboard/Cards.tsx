  ...
  return (
    <section className="w-full flex lg:justify-center max-lg:flex-col max-lg:items-center mb-20 gap-7">
      ...
      <div className="bg-[#FFC700] bg-opacity-40 lg:w-[40%] w-[80%] h-[380px] max-lg:flex max-lg:justify-between max-lg:items-center max-lg:pl-8 rounded-xl relative cursor-pointer hover:scale-105  max-lg:h-[175px]  transition-all duration-300">
        <div>
          <h2 className="text-black font-semibold text-xl lg:mt-8 lg:ml-8 max-lg:mb-4"> ¿Aún no sabes cual elegir? </h2>
          <p className="text-black text-xl lg:ml-8 max-lg:w-[190px] text-wrap"> Descubre los nuevos lanzamientos </p>
        </div>

        <img src="phonesCard3.png" alt="imagen" className="w-[30%] lg:w-[50%] absolute bottom-0 max-lg:right-7 lg:left-1/2 lg:-translate-x-1/2" />
      </div>
    </section >
  )
}